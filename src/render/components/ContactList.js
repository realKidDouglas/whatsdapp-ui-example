                ...
                <List>
                    ...
                    {this.props.sessions.map((session, index) => {
                        return (
                            <ListItem
                                    button
                                    selected={session.handle === this.props.openedContact.handle}
                                    key={index}
                                    onClick={((e) => this.onContactOpened(session))}>
                                <ListItemAvatar>
                                    {this.props.handlesWithNewMessage.indexOf(session.handle) > -1 ?
                                ...
                                <ListItemText primary={session.handle} secondary="secondary text"/>
                            </ListItem>
                        )
                    })}
